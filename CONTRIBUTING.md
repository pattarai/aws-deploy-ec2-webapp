...
## Please make sure you are assigned to an [Issue](https://github.com/pattarai/aws-deploy-ec2-webapp/issues) before submitting a pull request

Go to the [issue](https://github.com/pattarai/aws-deploy-ec2-webapp/issues) page and either
...
```
git remote add upstream https://github.com/pattarai/aws-deploy-ec2-webapp.git
